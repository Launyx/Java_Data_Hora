...
public class ConvertendoData {
    public static void main(String[] args) {
        ...
        // Formatação de data para instant usando o fuso horario do sistema local
        ...
        // instant não tenho .format(), portanto usa-se no DateTimeFormatter passando a data como argumento
